...
checkpoint_path = "../model/banklogo2.h5"
...
if is_train is True:
    ...
    autoencoder.load_weights('../model/banklogo_huangling_2.h5')

decoded_imgs = autoencoder.predict(X_test)

save_dir = r'E:\CheckDS\bank_huanling_decoder'
save_en = '{}_en.jpg'
save_de = '{}_de.jpg'
